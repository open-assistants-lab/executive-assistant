...
- DB connection churn + scheduler race conditions: add asyncpg pools and atomic claim/lock for pending reminders/jobs to avoid duplicates. `src/executive_assistant/storage/user_registry.py` `src/executive_assistant/storage/reminder.py` `src/executive_assistant/storage/scheduled_jobs.py` `src/executive_assistant/scheduler.py`
