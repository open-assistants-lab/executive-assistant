...
class TestMemoryGetHistory:
    ...
    def test_memory_get_history_empty(self):
        ...
        with patch("src.tools.memory.get_messages", return_value=[]):
    ...
    def test_memory_get_history_with_messages(self):
        ...
        with patch("src.tools.memory.get_messages", return_value=mock_messages):
            result = memory_get_history.invoke({"user_id": TEST_USER_ID})
...
class TestMemorySearch:
    ...
    def test_memory_search_empty_results(self):
        ...
        with patch("src.tools.memory.search_memories", return_value=[]):
    ...
    def test_memory_search_with_results(self):
        ...
        with patch("src.tools.memory.search_memories", return_value=mock_results):
