...
class TestContactsList:
    ...
    def test_contacts_list_empty(self):
        ...
        with patch("src.tools.contacts.tools.get_contacts", return_value=[]):
            with patch("src.tools.contacts.tools.get_contacts_count", return_value={"total": 0}):
    ...
    def test_contacts_list_with_contacts(self):
        ...
        with patch("src.tools.contacts.tools.get_contacts", return_value=mock_contacts):
            with patch("src.tools.contacts.tools.get_contacts_count", return_value={"total": 1}):
                result = contacts_list.invoke({"user_id": TEST_USER_ID})
...
class TestContactsGet:
    ...
    def test_contacts_get_not_found(self):
        ...
        with patch("src.tools.contacts.tools.storage_get_contact", return_value=None):
    ...
    def test_contacts_get_found(self):
        ...
        with patch("src.tools.contacts.tools.storage_get_contact", return_value=mock_contact):
...
class TestContactsAdd:
    ...
    def test_contacts_add_success(self):
        ...
        with patch(
            "src.tools.contacts.tools.storage_add_contact",
...
class TestContactsUpdate:
    ...
    def test_contacts_update_success(self):
        ...
        with patch(
            "src.tools.contacts.tools.storage_update_contact",
...
class TestContactsDelete:
    ...
    def test_contacts_delete_success(self):
        ...
        with patch(
            "src.tools.contacts.tools.storage_delete_contact",
            return_value={"success": True},
        ):
            result = contacts_delete.invoke(
...
class TestContactsSearch:
    ...
    def test_contacts_search_empty(self):
        ...
        with patch("src.tools.contacts.tools.search_contacts", return_value=[]):
    ...
    def test_contacts_search_results(self):
        ...
        with patch("src.tools.contacts.tools.search_contacts", return_value=mock_results):
