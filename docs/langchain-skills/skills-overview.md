# Skills - LangChain Multi-Agent Documentation

**Source:** https://docs.langchain.com/oss/python/langchain/multi-agent/skills

## Overview

In the **skills** architecture, specialized capabilities are packaged as invokable "skills" that augment an [agent's](https://docs.langchain.com/oss/python/langchain/agents) behavior. Skills are primarily prompt-driven specializations that an agent can invoke on-demand.
