...
# Note: This will use the default "Executive Assistant" name. For dynamic name, use get_default_system_prompt()
DEFAULT_SYSTEM_PROMPT = """You are Executive Assistant, a helpful AI assistant with access to various tools.
