...
class Settings(BaseSettings):
    ...
    # Prompt Composition and Budgeting
    PROMPT_INCLUDE_SKILLS_INDEX: bool = _yaml_field("PROMPT_INCLUDE_SKILLS_INDEX", True)
    PROMPT_LAYER_CAP_ADMIN_TOKENS: int = _yaml_field("PROMPT_LAYER_CAP_ADMIN_TOKENS", 600)
    PROMPT_LAYER_CAP_SKILLS_TOKENS: int = _yaml_field("PROMPT_LAYER_CAP_SKILLS_TOKENS", 300)
    PROMPT_LAYER_CAP_INSTINCT_TOKENS: int = _yaml_field("PROMPT_LAYER_CAP_INSTINCT_TOKENS", 220)
    PROMPT_LAYER_CAP_USER_PROMPT_TOKENS: int = _yaml_field("PROMPT_LAYER_CAP_USER_PROMPT_TOKENS", 400)
    PROMPT_LAYER_CAP_EMOTIONAL_TOKENS: int = _yaml_field("PROMPT_LAYER_CAP_EMOTIONAL_TOKENS", 60)
    PROMPT_MAX_SYSTEM_TOKENS: int = _yaml_field("PROMPT_MAX_SYSTEM_TOKENS", 2_800)
    PROMPT_WARN_TOKENS: int = _yaml_field("PROMPT_WARN_TOKENS", 2_500)
    PROMPT_ERROR_TOKENS: int = _yaml_field("PROMPT_ERROR_TOKENS", 3_000)
    PROMPT_TELEMETRY_ENABLED: bool = _yaml_field("PROMPT_TELEMETRY_ENABLED", True)
    PROMPT_TOOL_DESCRIPTION_OPTIMIZE: bool = _yaml_field("PROMPT_TOOL_DESCRIPTION_OPTIMIZE", True)
    PROMPT_TOOL_DESCRIPTION_MAX_CHARS: int = _yaml_field("PROMPT_TOOL_DESCRIPTION_MAX_CHARS", 220)
