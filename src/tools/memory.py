"""Progressive disclosure tool - allows agent to query historical context and memories."""
...
class ProgressiveDisclosureTool:
    ...
    def get_conversation_history(self, days: int = 7, date_str: str | None = None) -> str:
        ...
        result: str = memory_get_history.invoke(
    ...
    def search_conversation_hybrid(self, query: str) -> str:
        ...
        result: str = memory_search.invoke({"query": query, "user_id": self.user_id})
        return result
