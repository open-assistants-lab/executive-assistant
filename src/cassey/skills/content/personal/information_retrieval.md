...
insert_db_table(
    "notes",
    '[{"title": "Architecture decision", "type": "decision", "project": "Cassey", "tags": "technical,important", "date": "2025-01-19"}]'
)

# Easier to find:
query_db("SELECT * FROM notes WHERE type = 'decision' AND project = 'Cassey'")
```
...
create_vs_collection(
    "decisions",
    content="...",
    metadata={"type": "decision", "project": "Cassey", "category": "technical", "date": "2025-01-19"}
)
